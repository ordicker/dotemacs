* Notes 
** emacs configuration
--prefix=/usr/local/stow/emacs-30.2 --with-x --with-pgtk --with-mailutils --with-modules --with-json --with-native-compilation=aot --with-tree-sitter --with-imagemagick
* Emacs configuration
** Get to here
...
#+begin_src emacs-lisp
 (use-package windmove
  :ensure nil
  :bind*
  (("M-<left>" . my/windmove-or-sway-left)
   ("M-<right>" . my/windmove-or-sway-right)
   ("M-<up>" . my/windmove-or-sway-up)
   ("M-<down>" . my/windmove-or-sway-down))
  :init
...
#+begin_src emacs-lisp
  (use-package aidermacs
      ...
      (aidermacs-extra-args '("--copy-paste" "--no-show-model-warnings"))
      ;(aidermacs-config-file "~/.aider/.aider.conf.yml")
  )
#+end_src
